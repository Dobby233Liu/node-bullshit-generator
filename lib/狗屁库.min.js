 ...
 */var s=function(){function e(){!function(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,e),r(this,"默认选项",{"有概率不添加后面垫话":!1,"v3语法改进":!0,"menzi11#175":!0,"允许字典处理字符串":!0}),r(this,"默认字典",t("./dict/default/配置")),r(this,"常用",t("./常用")),r(this,"随机",t("./随机常用")),r(this,"generate",this.生成)}var i,s,o;return i=e,s=[{key:"生成",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"学生会退会",e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:6e3*t.length,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:this.默认字典,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:this.默认选项;this.选项=this.常用.合并对象(n,this.默认选项),this.字典=this.常用.合并对象(i,this.默认字典),this.选项["允许字典处理字符串"]&&this.字典["主题处理"]&&"function"==typeof this.字典["主题处理"]&&(t=this.字典["主题处理"](t,this.字典,this.选项,this.常用,this.随机)),this.起段=this.字典.起段,this.前面垫话=this.字典.前面垫话,this.后面垫话=this.字典.后面垫话,this.选项["menzi11#175"]&&(this.下一句前面垫话=this.随机.洗牌遍历(this.字典.前面垫话),this.下一句后面垫话=this.随机.洗牌遍历(this.字典.后面垫话)),this.下一句名人名言=this.随机.洗牌遍历(this.字典.名人名言),this.下一句废话=this.随机.洗牌遍历(this.字典.废话);for(var r=this.起段.replace(/\{主题\}/g,t),s="",o="忽略";r.length<e||this.选项.v3语法改进&&(r.trim().endsWith("：")||r.trim().endsWith(":")||r.trim().endsWith(",")||r.trim().endsWith("，"));){s="",o="忽略";var h=Math.floor(100*Math.random());if(!(h<5)||this.选项.v3语法改进&&(r.endsWith(this.起段)||r.trim().endsWith(",")||r.trim().endsWith("，")))if(h<20){var u=this.下一句名人名言.next().value;u=u.replace(/\{前面垫话\}/g,(this.选项["menzi11#175"]?this.下一句前面垫话.next().value:this.随机.瞎选一个(this.前面垫话)).replace(/\{主题\}/g,t)),s=u=this.选项.有概率不添加后面垫话&&1==Math.floor(10*Math.random())?u.replace(/\{后面垫话\}/g,""):u.replace(/\{后面垫话\}/g,(this.选项["menzi11#175"]?this.下一句后面垫话.next().value:this.随机.瞎选一个(this.后面垫话)).replace(/\{主题\}/g,t)),o="名人名言"}else s=this.下一句废话.next().value.replace(/\{主题\}/g,t),o="废话";else s=!this.选项.v3语法改进||this.常用.能否以句号结束(r.trim())?this.字典.句号.replace(/\{主题\}/g,t):"",s+="\n",s+=this.起段.replace(/\{主题\}/g,t),o="新行";this.选项["允许字典处理字符串"]&&this.字典["缓冲处理"]&&"function"==typeof this.字典["缓冲处理"]?r+=this.字典["缓冲处理"](s,this.字典,this.选项,this.常用,this.随机,o):r+=s}return s="",this.选项["允许字典处理字符串"]&&this.字典["文章处理"]&&"function"==typeof this.字典["文章处理"]&&(r=this.字典["文章处理"](r,this.字典,this.选项,this.常用,this.随机)),r}}],s&&n(i.prototype,s),o&&n(i,o),e}();e.exports=s},{"./dict/default/配置":5,"./常用":6,"./随机常用":8}],8:[function(t,e,i){"use strict";function n(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}var r=function(){function t(){!function(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,t)}var e,i,r;return e=t,r=[{key:"洗牌",value:function(t){for(var e=t.slice(),i=e.length-1;i>0;i--){var n=Math.floor(Math.random()*(i+1)),r=[e[n],e[i]];e[i]=r[0],e[n]=r[1]}return e}},{key:"瞎选一个",value:function(t){var e=t.length;return t[Math.floor(Math.random()*(e-0))+0]}},{key:"洗牌遍历",value:function(t){for(var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1,i=[],n=0;n<e;n++)i=i.concat(t);return i=this.洗牌(i),{next:function(t,e){var n=0,r=e.slice();return function(){var e=r[n++];return n<i.length||(r=t(r),n=0),{value:e,done:!1}}}(this.洗牌,i)}}}],(i=null)&&n(e.prototype,i),r&&n(e,r),t}();e.exports=r},{}]},{},[7])(7)}));