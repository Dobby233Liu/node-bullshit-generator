...
*/
function 生成狗屁(主题 = "学生会退会", 名人名言 = require("./dict/default/名人名言.js"),
	前面垫话 = require("./dict/default/前面垫话.js"),
	后面垫话 = require("./dict/default/后面垫话.js"),
	废话 = require("./dict/default/废话.js")(主题),
	选项 = { "分支大于24时加废话": false, "检测到底应该如何和又会如何产生": true, "有概率不添加后面垫话": true, "有时不加废话": true, "之前处理过废话的话不要处理名言": true }
){
	/**
	 * @param {Array} 数组
	 */
	...
	if (tmp.endsWith("：") || tmp.endsWith(":") || tmp.endsWith(",") || tmp.endsWith("，")) {
		if(下一句废话.length - 1 == 下一句废话到哪儿了) 下一句废话到哪儿了 = 0;
