...
function 生成狗屁(主题 = "学生会退会", 名人名言 = [
		...
		"有一个人a，感激每一个新的挑战，因为它会锻造你的意志和品格。b",
		...
		"德国的百姓a，只有在人群中间，才能认识自己。b",
		"史美尔斯a，书籍把我们引入最美好的社会，使我们认识各个时代的伟大智者。b",
		"冯学峰a，当一个人用工作去迎接光明，光明很快就会来照耀着他。b",
		"吉格·金克拉a，如果你能做梦，你就能实现它。b"
	],
	前面垫话 = ["曾经说过", "在不经意间这样说过", "说过一句著名的话", "曾经提到过", "说过一句富有哲理的话"],
	后面垫话 = ["这不禁令我深思。", "带着这句话，我们还要更加慎重的审视这个问题：", "这启发了我。", "我希望诸位也能好好地体会这句话。", "这句话语虽然很短，但令我浮想联翩。", "这句话看似简单，但其中的阴郁不禁让人深思。", "这句话把我们带到了一个新的维度去思考这个问题：", "这似乎解答了我的疑惑。"],
	废话 = ["现在，解决" + 主题 + "的问题，是非常非常重要的。所以，", "我们不得不面对一个非常尴尬的事实，那就是，",
	...
	选项 = { "分支大于24时加废话": false, "检测到底应该如何和又会如何产生": true, "有概率不添加后面垫话": true, "有时不加废话": true, "fuck名言": false }
){
	/**
	 * @param {Array} 数组
	 */
	...
	var 下一句名人名言到哪儿了 = 0;
	var 来点名人名言 = function () {
		if ((选项.fuck名言||false)&&下一句名人名言到哪儿了&3) return "";
	...
	maketmp: while (tmp.length < 6000 * 主题.length) {
		...
		if(分支 < 5 && !tmp.endsWith("    ") && !tmp2.endsWith(",") && !tmp2.endsWith("，")) tmp2 = 另起一段(能否以句号结束(tmp2.trim()));
		else if(分支 < 20) tmp2 = 来点名人名言();
