...
var 常用 = /*#__PURE__*/function () {
  ...
  _createClass(常用, null, [{
    ...
    key: "\u8FD9\u662F\u5565\u6211\u4E5F\u4E0D\u77E5\u9053",
    value: function 这是啥我也不知道(主要的, 次要的) {
      // 申密函数
...
var 狗屁库 = /*#__PURE__*/function () {
  ...
  _createClass(狗屁库, [{
    ...
    value: function 生成() {
      ...
      while (this.常用.总长(文章) < 长度 && (!this.选项["能写少就写少"] || this.常用.总长(文章) + 段缓冲.length < 长度) || this.选项.v3语法改进 && this.常用.是否以字符串结束(this.常用.这是啥我也不知道(段缓冲, 文章).trim(), ["：", ":", ",", "，"])) {
        var 缓冲 = "";
        类型 = "忽略";
