...
var 随机常用 = /*#__PURE__*/function () {
  ...
  _createClass(随机常用, null, [{
    ...
    key: "\u6D17\u724C\u904D\u5386",
    value: /*#__PURE__*/regeneratorRuntime.mark(function 洗牌遍历(数组) {
      var 重复度,
          次数组,
          i,
          次次数组,
      ...
      return regeneratorRuntime.wrap(function 洗牌遍历$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              重复度 = _args.length > 1 && _args[1] !== undefined ? _args[1] : 1;
              次数组 = [];
            ...
            case 3:
              ...
              次次数组 = this.洗牌(次数组);
              _iterator = _createForOfIteratorHelper(次次数组);
              _context.prev = 6;
