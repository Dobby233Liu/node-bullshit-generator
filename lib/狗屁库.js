...
function 生成狗屁(主题){
	...
	var 来点名人名言 = function () {
		...
		xx = xx.replace(/a/, 瞎选一个(前面垫话))
		xx = xx.replace(/b/, 瞎选一个(后面垫话))
		if(下一句名人名言.length - 1 == 下一句名人名言到哪儿了) 下一句名人名言到哪儿了 = 0;
		else 下一句名人名言到哪儿了++;
		return xx
	}
	var 另起一段 = function () {
