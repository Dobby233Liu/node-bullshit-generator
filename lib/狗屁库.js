    ...
    value: function _() {
      ...
      写文: while (文章.length < 长度 || (this.选项.v3语法改进 ? 文章.trim().endsWith("：") || 文章.trim().endsWith(":") || 文章.trim().endsWith(",") || 文章.trim().endsWith("，") : false)) {
        ...
        if (分支 < 5 && (this.选项.v3语法改进 ? (!this.起段 || !文章.endsWith(this.起段)) && !文章.trim().endsWith(",") && !文章.trim().endsWith("，") : true)) {
          if (this.常用.能否以句号结束(文章.trim())) 缓冲 = this.字典.句号;else 缓冲 = "";
          缓冲 += "\n";
          缓冲 += this.起段;
        } else if (分支 < 20) {
...
module.exports = 狗屁库;
},{"./dict/default/配置":5,"./常用":6,"./随机常用":8,"core-js/modules/es.string.ends-with":86,"core-js/modules/es.string.replace":87,"core-js/modules/es.string.trim":88}],8:[function(require,module,exports){
"use strict";
