...
module.exports = {
    ...
    "author": ["Lao Tzu", "Plato", "Jacqueline Carey", "Napoleon Bonaparte", "Plato", "James Thurber", "Emil Cioran", "David Mamet", "Mokokoma Mokhonoana", "Franz Kafka", "Steve Wozniak",
        //"Friedrich Nietzsche", 
        "Rebecca West", "Rebecca McClanahan", "Mokokoma Mokhonoana", "Marty Rubin", "Kamand Kojouri",
        //"William Penn", 
        "Friedrich Von Schlegel", "S. Spencer Baker", "Orson Scott Card", "Ljupka Cvetanova", "Comte de Lautréamont"
    ],
    "saying": ["the flame that burns twice as bright burns half as long.", "there is truth in wine and children.", "that which yields is not always weak.", "if you want a thing done well, do it yourself.", "necessity is the mother of invention.", "all human beings should try to learn before they die what they are running from, and to, and why.", "melancholy is an appetite no misery satisfies.", "it's only words, unless they're true.", "plants are more courageous than almost all human beings - an orange tree would rather die than produce lemons, whereas instead of dying the average person would rather be someone they are not.", "if a man has his eyes bound, you can encourage him as much as you like to stare through the bandage, but he'll never see anything.", "never trust a computer you can't throw out a window.",
        //"I have forgotten my umbrella.", 
        "the trouble about men is twofold - one cannot learn truths which are too complicated, while one forgets truths which are too simple.", "the shortest distance between two points is always under construction.", "some people talk about other people’s failures with so much pleasure that you would swear they are talking about their own successes.", "there is music you never hear unless you play it yourself.", "what you choose also chooses you.",
        //"all Excess is ill, but Drunkenness is of the worst Sort - it spoils Health, dismounts the Mind, and unmans Men, and it reveals Secrets, is Quarrelsome, Lascivious, Impudent, Dangerous and Mad. A drunk Man is not a Man, because he is so long void of Reason, that distinguishes a Man from a Beast.", 
        "an aphorism ought to be entirely isolated from the surrounding world like a little work of art and complete in itself like a hedgehog.", "laughter is the antidote to existential pain.", "never mock a tender heart.", "smile and the world will laugh at you.", "people say sound things when they do not strive to say to say extraordinary ones."
    ]
}